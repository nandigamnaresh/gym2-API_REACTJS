...
function App2() {
    ...
    const [a, b]=useState();
    const [c, d] =useState("shoulders")
    const [e, f] =useState(20)
    ...
    const Data = async () => {
        const options = {
            method: 'GET',
            url: `https://exercisedb.p.rapidapi.com/exercises/bodyPart/${c}`,
            params: { limit: `${e}` },
            headers: {
    ...
    // arms, chest, back, shoulders, core, and legs.
    ...
    return (
        <div>
            ...
            <h2 className='text-center  fw-bold pb-5 pt-3' style={{color:"GREEN" ,border:"2px solid white",backgroundColor:"white"}}>GYM PRACTICE2</h2>
            <div className='container'> 
                <div className='row ms-5'>
                    <input className='fw-900 ms-5 mt-3 mb-2' type='text' placeholder='SEARCH BODY PART NAME' onChange={chinna} />
                    <input className='fw-900 ms-5 mt-3 mb-2' type='number' placeholder='LIMIT' onChange={chinna1} value={e} />
